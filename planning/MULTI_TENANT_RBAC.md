...
Branch `feat/rbac-multi-tenant`, nove migrations (`migration_rbac_01…09`), 26 edge functions
...
| 6 · Produto | parcial | QG completo (D25); trocar de escritório; convite por papel; tela do escritório para aprovar/encerrar suporte + trilha na Auditoria (23/09); integrações por escritório — Gmail do INSS, DJEN e WhatsApp (23/09, `migration_rbac_09`). **Faltam**: Legalmail/TI por escritório, n8n lendo a instância por escritório, marca por escritório, export por escritório |
