...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Legal Connect" },
      { name: "description", content: "Legal Connect: gestão de casos previdenciários para escritórios e parceiros." },
      { name: "theme-color", content: "#16243D" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "Legal Connect" },
      { name: "apple-mobile-web-app-status-bar-style", content: "default" },
    ],
    links: [
      // Fontes por <link>, nao por @import no CSS (issue #199: o Tailwind v4
      // descartava o @import e todo mundo via a fonte de fallback).
