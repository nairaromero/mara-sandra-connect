...
async function esperarRota(page, rotas, rotulo, ms = 15000) {
  ...
  await page.screenshot({ path: path.join(__dirname, "..", "saida", "lote-rbac-local", "stills", `falha-${rotulo}.png`) }).catch(() => {});
